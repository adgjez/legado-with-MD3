...
object PreferKey {
    ...
    const val aiSanitizeCustomPrompt = "aiSanitizeCustomPrompt"
    ...
    const val aiAudioProviderList = "aiAudioProviderList"
    const val aiCurrentAudioProviderId = "aiCurrentAudioProviderId"
    const val aiSanitizeEnabled = "aiSanitizeEnabled"
    const val aiSanitizeTrigger = "aiSanitizeTrigger"
    const val aiSanitizeIntensity = "aiSanitizeIntensity"
    ...
    const val aiCleanupThresholdBytes = "aiCleanupThresholdBytes"
    const val aiCleanupMaxAgeDays = "aiCleanupMaxAgeDays"
